  ...
  return (
    <footer className="relative bottom-0 left-0 w-full px-5 flex flex-col border-dashed border-t border-gray-700 mt-8 py-4 justify-center items-center md:justify-between md:flex-row">
      <div className="flex space-x-4 md:space-x-8 order-1 md:order-2">
        <a
          href="https://github.com/PRATHAM2002-DS"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          href="https://www.linkedin.com/in/pratham-more-7688571b5/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          href="https://www.instagram.com/prathammore20/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          href="mailto:pratham02more20@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
          <svg
